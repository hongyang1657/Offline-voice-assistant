...
public class MediaPauseModel implements IMediaPausePresenter {

    private MediaPausePresenter mediaPausePresenter;

    public MediaPauseModel(MediaPausePresenter mediaPausePresenter) {
        this.mediaPausePresenter = mediaPausePresenter;
    }
    ...
    public void mediaPause(int position) {
        ...
        params.put("method","player/pause");
        ...
        ApiManager.MediaPlayerService.mediaPause(apikey,timeStamp,sign, HttpConstant.API_VERSION,"player/pause",map)
                ...
                .subscribe(new Subscriber<Status>() {
                    ...
                    public void onError(Throwable e) {
                        L.i("mediaPause_e:"+e.toString());
                    }

                    @Override
                    public void onNext(Status responseBody) {
                        mediaPausePresenter.onSucess(responseBody);
                    }
                });
    }
